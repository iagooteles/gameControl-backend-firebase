...
public class UsuarioPlaylistController {
    ...
    @PostMapping
    public ResponseEntity<?> criarPlaylist(@Valid @RequestBody CreatePlaylistRequest request) {
        try {
            // Repassa o objeto exatamente como veio do Frontend
            UsuarioPlayListDTO nova = usuarioPlaylistService.criarPlaylist(request);
